...
namespace CShapeWinFormHomework01
{
    internal class ShareData
    {
        ...
        private static void tb_KeyPressNum(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true; // ไม่อนุญาตให้ป้อนอักขระที่ไม่ใช่ตัวเลข
            }
        }


        public static void tb_KeyPressDecimal(object sender, KeyPressEventArgs e)
        {
